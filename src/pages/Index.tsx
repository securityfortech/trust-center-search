      ...
      <DataProvider csvUrl={GOOGLE_SHEETS_URL}>
        ...
        return (
          <>
            ...
            {isMobile ? (
              <footer className="w-full bg-gradient-to-t from-gray-100 to-white dark:from-gray-800 dark:to-gray-900 py-3 mt-auto border-t border-gray-200 dark:border-gray-700">
