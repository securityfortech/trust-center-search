...
const Header: React.FC<HeaderProps> = ({
  ...
  if (isMobile) {
    return <header className="bg-background dark:bg-gray-900 pt-6 pb-2 flex flex-col items-center justify-center animate-fade-in">
  ...
  return <header className="bg-white dark:bg-gray-900 flex flex-col items-center justify-center min-h-[40vh] pb-3 animate-fade-in">
      <div className="container mx-auto px-4 flex flex-col items-center">
