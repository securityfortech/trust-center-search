        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="space-y-4 text-center md:text-left flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-col space-y-3 items-center md:items-start">
              <Link to="/add-trust-center" className="group text-muted-foreground hover:text-primary text-sm md:text-base transition-colors inline-flex items-center">
                <span className="border-b border-transparent group-hover:border-current transition-colors">Add your Trust Center</span>
              </Link>
              <button onClick={handleCopyLink} className="group text-muted-foreground hover:text-primary text-sm md:text-base transition-colors inline-flex items-center">
