...
const CompanyResults: React.FC<CompanyResultsProps> = ({
  ...
  if (isInitialLoad) {
    return <div className="flex flex-col items-center justify-center pb-2 animate-fade-in mt-0 py-[12px]">
  ...
  return <div className="animate-fade-in bg-gray-50 dark:bg-gray-900 -mt-4 py-2 rounded-t-md">
      {filteredCompanies.length === 0 ? <div className="flex flex-col items-center justify-center py-3">
        ...
        </div> : <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 px-3 md:px-6">
